...
const narration = [
  ...
  "Our enrolled participant has twelve ordered modules, cohort dates, and a named mentor. Progress comes from recorded work. Trying to open a future module returns to the curriculum with an explanation of how to unlock it.",
  ...
  "Select an open time and confirm one booking. The session allowance updates from two to three of six. Returning to the curriculum shows the same upcoming conversation, with its mentor, time, duration, and time zone.",
  ...
  "A second prepared account has finished the programme. All twelve modules are complete, and the cohort has ended. The curriculum remains available for review. Six historical sessions remain visible, while new bookings are unavailable.",
